...
While waiting for the MEK/D2 to arrive, I digged up as much information on the internet as I could; what a difference with the time I originally worked with the MEK6800D2 as that was pre-Internet!
...
The MEK6800D2 arrived, complete with the manual and an old power supply suitable for 110V/60Hz AC which I dumped in the trash bin and I connected my Lab PSU to test it.
...
As can be seen on the display of the Lab PSU, the MEK6800D2 in its 'naked' form draws about 1 Amp of power at 5V, roughly 5 Watt.
...
This briefly describes the main characteristics of the **Motorola MEK6800D2 Evaluation Kit II** as it was officially named and in follow-up posts I will go into the details of my journey using/programming and expaning the system, like adding other EPROMS, using MINIBUG, adding memmory cards, extra serial intterfaces, etc. and I will even attempt to add a 5.25 inch floppy drive to it (once I get hold of one).
